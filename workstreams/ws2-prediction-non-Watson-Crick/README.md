...
- Specify the ID of the structure in the URL, e.g., "localhost:9080/rna2d.html?mmdbid=9CFN". For local mmcif file, use "localhost:9080/rna2d.html?type=mmcif&url=./[file].mmcif".
